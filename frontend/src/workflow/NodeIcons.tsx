  ...
  switch (type) {
    ...
    case 'textNote':
      return (
        <svg {...common}>
          <path
            d="M6 4h12a2 2 0 012 2v14l-4-3H6a2 2 0 01-2-2V6a2 2 0 012-2z"
            stroke={stroke}
            strokeWidth="1.75"
            strokeLinejoin="round"
          />
          <path d="M8 9h8M8 13h6M8 17h4" stroke={stroke} strokeWidth="1.75" strokeLinecap="round" />
        </svg>
      )
    case 'refDescription':
      return (
    ...
    case 'scenarioLocationChange':
      return (
        <svg {...common}>
          <circle cx="12" cy="12" r="7" stroke={stroke} strokeWidth="1.75" />
          <path
            d="M12 5v14M5 12h14"
            stroke={stroke}
            strokeWidth="1.75"

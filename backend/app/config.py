...
class Settings(BaseSettings):
    ...
    studio_evolink_20_usd_per_sec_with_ref: float = Field(default=0.08, ge=0.0)
    studio_evolink_20_usd_per_sec_no_ref: float = Field(default=0.056, ge=0.0)
    ...
    studio_evolink_25_usd_per_sec_with_ref: float = Field(default=0.12, ge=0.0)
    studio_evolink_25_usd_per_sec_no_ref: float = Field(default=0.09, ge=0.0)

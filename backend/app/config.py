...
class Settings(BaseSettings):
    ...
    image_studio_model_profile_gen_system_path: str = Field(
        default="data/prompts/female_character_appearance_from_photos_system.txt",
    )
    ...
    # Face swap seedream-v5.0-pro: Grok master prompt + Image1=ref, Image2=face, Image3=body (без mannequin).
    studio_face_swap_seedream_v5_classic: bool = Field(default=True)
    ...
    # Seedance 2.5 T2V — https://wavespeed.ai/models/bytedance/seedance-2.5/text-to-video
    wavespeed_seedance_25_t2v_path: str = Field(
    ...
    # Standard motion control → seedance-2.0-fast + reference_videos (720p): $0.13/с billed (ref+output)
    ...
    evolink_platform_api_key: str = Field(default="")
    evolink_video_enabled: bool = Field(default=True)
    evolink_video_poll_interval_seconds: float = Field(default=5.0, ge=1.0)
    evolink_video_max_polls: int = Field(default=240, ge=30, le=1200)
    evolink_video_duration_min: int = Field(default=4, ge=4, le=30)
    evolink_video_duration_max_20: int = Field(default=15, ge=4, le=15)
    evolink_video_duration_max_25: int = Field(default=30, ge=4, le=30)
    evolink_video_duration_default: int = Field(default=5, ge=4, le=30)
    evolink_video_default_resolution: str = Field(default="720p")
    # Seedance 2.0 Sale → EvoLink Fast tier (−25% vs Standard; см. evolink.ai/seedance-2-0)
    studio_evolink_20_usd_per_sec_output_720p: float = Field(default=0.149, ge=0.0)
    studio_evolink_20_usd_per_sec_output_480p: float = Field(default=0.069, ge=0.0)
    studio_evolink_20_usd_per_sec_video_ref_720p: float = Field(default=0.091, ge=0.0)
    studio_evolink_20_usd_per_sec_video_ref_480p: float = Field(default=0.042, ge=0.0)
    studio_evolink_25_usd_per_sec_output_720p: float = Field(default=0.293, ge=0.0)
    studio_evolink_25_usd_per_sec_output_480p: float = Field(default=0.136, ge=0.0)
    studio_evolink_25_usd_per_sec_video_ref_720p: float = Field(default=0.179, ge=0.0)
    studio_evolink_25_usd_per_sec_video_ref_480p: float = Field(default=0.083, ge=0.0)
    studio_evolink_20_usd_per_sec_with_ref: float = Field(default=0.091, ge=0.0)
    studio_evolink_20_usd_per_sec_no_ref: float = Field(default=0.149, ge=0.0)
    studio_evolink_mini_usd_per_sec_with_ref: float = Field(default=0.06, ge=0.0)
    studio_evolink_mini_usd_per_sec_no_ref: float = Field(default=0.045, ge=0.0)
    studio_evolink_25_usd_per_sec_with_ref: float = Field(default=0.179, ge=0.0)
    studio_evolink_25_usd_per_sec_no_ref: float = Field(default=0.293, ge=0.0)

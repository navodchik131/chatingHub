...
class Settings(BaseSettings):
    ...
    # Первый кадр (архив) часто триggerит sensitive у Seedance — сцена остаётся в тексте промпта.
    studio_seedance_video_skip_start_frame_ref: bool = Field(default=True)

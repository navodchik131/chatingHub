...
class Settings(BaseSettings):
    ...
    studio_evolink_20_usd_per_sec_output_720p: float = Field(default=0.199, ge=0.0)
    studio_evolink_20_usd_per_sec_output_480p: float = Field(default=0.092, ge=0.0)
    studio_evolink_20_usd_per_sec_video_ref_720p: float = Field(default=0.121, ge=0.0)
    studio_evolink_20_usd_per_sec_video_ref_480p: float = Field(default=0.056, ge=0.0)
    ...
    studio_evolink_20_usd_per_sec_with_ref: float = Field(default=0.121, ge=0.0)
    studio_evolink_20_usd_per_sec_no_ref: float = Field(default=0.199, ge=0.0)

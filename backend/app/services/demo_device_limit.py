...
Используется при регистрации (demo_grant_for_device), чтобы ограничить повторные
аккаунты с одного устройства. Списание при генерации идёт по балансу аккаунта.
"""

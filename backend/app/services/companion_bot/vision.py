...
async def _describe_fan_image_openai(
    *,
    ...
    instruction = (
        ...
        "Write 2–4 plain English sentences for the chatter ONLY:\n"
        "- What is visibly in the image (people, setting, objects, mood, notable details)\n"
        "- How it likely connects to the chat thread (if obvious from context + caption)\n"
        "- If it looks like a meme, selfie, outfit, pet, food, screenshot, etc. — say so\n"

...
DEFAULT_FACE_MERGE_PROMPT = (
    ...
    "- Natural iris depth without oversized doll detail, asymmetric catchlights reflecting the studio light, moist natural eye surface.\n"
    "- Individual lower and upper lashes, natural tear line, soft realistic under-eye texture.\n"
    "- Candid micro-expression — soft squint or half-smile, not a blank model stare.\n\n"
    ...
    "- Tack-sharp focus on the eyes, ultra-detailed, high resolution, natural color grading.\n"
    "- Natural candid micro-expression — eyes alive with asymmetric catchlights, not vacant doll stare.\n\n"
...
DEFAULT_BODY_COMPOSE_PROMPT = (
    ...
    "- Absolutely NO plastic, waxy, airbrushed or AI-smooth skin.\n\n"
    "EYES (must look alive):\n"
    "- Natural iris depth without oversized doll detail, asymmetric catchlights, moist natural surface.\n"
